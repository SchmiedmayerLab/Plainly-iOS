...
extension Study {
    ...
    public static var gynStudy: Study {
        ...
        return Study(
            id: "edu.stanford.aihealthliteracy.gynStudy",
            title: "AIHealthLiteracy REI study",
...
private let finalTaskQuestions = [
    Study.Task.Question(text: "In the future if you had a chat bot like AIHealthLiteracy available…", type: .instructional),
    Study.Task.Question(
    ...
    Study.Task.Question(
        text: "How often would you turn to AIHealthLiteracy with questions before reaching out to a healthcare professional through myHealth?",
        type: .scale(responseOptions: .frequencyOptions),
        isOptional: false
    ),
    Study.Task.Question(
        text: "What questions would you feel confident consulting a chatbot like AIHealthLiteracy with access to your personal health record for?",
        type: .freeText,
        isOptional: false
    ),
    Study.Task.Question(
        text: "What questions would you NOT feel confident consulting a chatbot like AIHealthLiteracy with access to your electronic health record for?",
        type: .freeText,
        isOptional: false
    )
]
...
private let postInterventionQuestions = [
    Study.Task.Question(
        text: """
            ...
            Please answer these questions based on how you feel **with access to an application** like AIHealthLiteracy.
            """,
        type: .instructional
    ),
    Study.Task.Question(
...
extension FHIRPrompt {
    fileprivate static let gynStudySystemPrompt: Self = """
        You are the AIHealthLiteracy agent tasked with helping Reproductive Endocrinology & Infertility (REI) patients understand their current health, recent procedures and conditions related to their fertility and any questions they have while accessing their FHIR health records for additional context.  
