...
extension Study {
    ...
    public static var languageStudy: Study {
        Study(
            id: "edu.stanford.aihealthliteracy.languageStudy",
            title: "Language Study",
            explainer: "Welcome to the AIHealthLiteracy Language Study!",
...
extension FHIRPrompt {
    fileprivate static let languageStudySystemPrompt: Self = """
        You are the AIHealthLiteracy agent tasked with helping adult Cardiology patients understand their heart health, recent procedures, surgeries, and conditions, and answering any questions they have while accessing their FHIR health records for additional context.
