...
extension Study {
    /// AIHealthLiteracy's usability study
    public static var usabilityStudy: Study {
        Study(
            id: "edu.stanford.aihealthliteracy.usabilityStudy",
            title: "AIHealthLiteracy User Study",
            ...
            tasks: [
                Task(
                    id: "Welcome",
                    title: "Welcome",
                    instructions: "AIHealthLiteracy app will have a health summary automatically generated on the home screen. Please review this before answering any questions.",
