...
extension ClosedRange where Bound == Int {
    /// AIHealthLiteracy-usable-formatted string value
    public var aiHealthLiteracyStringValue: String {
        "\(lowerBound);\(upperBound)"
    }
    
    /// Decodes a value produced by ``aiHealthLiteracyStringValue`` back into a `ClosedRange`
    public init?(aiHealthLiteracyStringValue string: some StringProtocol) {
