...
public final class Study: Identifiable {
    ...
    public func initialQuestionnaire(from bundle: Bundle) throws -> Questionnaire? {
        ...
        guard let url = bundle.url(forResource: initialQuestionnaire, withExtension: "json") else {
            throw NSError(domain: "edu.stanford.aihealthliteracyShared", code: 0, userInfo: [
...
extension Study.Task: Codable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.init(
            ...
            assistantMessagesLimit: try { () -> ClosedRange<Int>? in
                ...
                if let val = ClosedRange<Int>(aiHealthLiteracyStringValue: string) {
                    return val
                } else {
    ...
    public func encode(to encoder: any Encoder) throws {
        ...
        try container.encodeIfPresent(assistantMessagesLimit?.aiHealthLiteracyStringValue, forKey: .assistantMessagesLimit)
