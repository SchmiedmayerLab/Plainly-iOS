...
extension AppConfigFile {
    ...
    ///
    /// Returns an empty ``AIHealthLiteracy/AIHealthLiteracy/Mode/standalone`` config if the file is not present or cannot be decoded.
...
extension AppConfigFile.FirebaseConfigDictionary {
    ...
    public static let emulator = Self(entries: [
        ...
        "PLIST_VERSION": "1",
        "BUNDLE_ID": "edu.stanford.aihealthliteracy",
