...
actor AIHealthLiteracyStandard: Standard, EnvironmentAccessible {
    ...
    private let logger = Logger(subsystem: "edu.stanford.aihealthliteracy", category: "AIHealthLiteracyStandard")
...
extension AIHealthLiteracyStandard: HealthKitConstraint {
