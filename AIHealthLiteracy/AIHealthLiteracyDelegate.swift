...
final class AIHealthLiteracyDelegate: SpeziAppDelegate {
    override var configuration: Configuration {
        Configuration(standard: AIHealthLiteracyStandard()) {
            ...
            HealthKit {
                if HKHealthStore().supportsHealthRecords() {
                    RequestReadAccess(other: AIHealthLiteracyStandard.recordTypes)
                    for type in AIHealthLiteracyStandard.recordTypes {
    ...
    nonisolated private var openAITokenConfig: RemoteLLMInferenceAuthToken {
        switch AIHealthLiteracy.mode {
        case .standalone, .test:
            .keychain(tag: .openAIKey, username: "AIHealthLiteracy_OpenAI_Token")
        case .study:
