...
private struct ScanQRCodeSheet: View {
    ...
    private var permissionsDeniedInfo: some View {
        ContentUnavailableView {
            ...
            Text("You must allow AIHealthLiteracy to access the camera in order to be able to scan a QR code")
        } actions: {
...
private struct DataScannerView: UIViewControllerRepresentable {
    ...
    private let logger = Logger(subsystem: "edu.stanford.aihealthliteracy", category: "QRCodeScanning")
