...
enum FeatureFlags {
    ...
    static let resetPreferences = CommandLine.arguments.contains("--resetPreferences")
    static let skipInitialQuestionnaire = CommandLine.arguments.contains("--skipInitialQuestionnaire")
