...
extension ModelsR4.Bundle {
    private static let lookup = ResourceBundlesLookup(
        rootUrl: Foundation.Bundle.plainlyShared.url(forResource: "Synthetic Patients", withExtension: nil)
    )
...
extension ModelsR4.Bundle {
    private struct ResourceBundlesLookup: Sendable {
        private static let logger = Logger(subsystem: "edu.stanford.plainly.PlainlyShared", category: "\(Self.self)")
