...
public struct AppConfigFile: Codable {
    ...
    public init(launchMode: AppLaunchMode, firebaseConfig: FirebaseConfigDictionary?) {
...
extension AppConfigFile {
    ...
    ///
    /// Returns a default configuration if the file is not present or cannot be decoded.
    public static func current() -> Self {
        guard let configuration = Self(nameInBundle: "UserStudyConfig") else {
            return Self(launchMode: .study(studyId: nil), firebaseConfig: nil)
        }
