...
extension FHIRPrompt {
    ...
    public static let interpretMultipleResourcesDefaultPrompt = FHIRPrompt(
        ...
        defaultPromptText: """
            You are the Plainly agent tasked with helping users understand their current health, recent procedures and conditions, and any questions they have while accessing their FHIR health records for additional context.
