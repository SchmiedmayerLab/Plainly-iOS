...
extension ClosedRange where Bound == Int {
    /// Plainly-usable-formatted string value
    public var plainlyStringValue: String {
        "\(lowerBound);\(upperBound)"
    }
    
    /// Decodes a value produced by ``plainlyStringValue`` back into a `ClosedRange`
    public init?(plainlyStringValue string: some StringProtocol) {
