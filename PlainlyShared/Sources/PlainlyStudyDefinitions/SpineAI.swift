...
extension FHIRPrompt {
    fileprivate static let spineAISystemPrompt: Self = """
        ...
        ANSWER LENGTH
        - Keep answers short. A typical answer runs about 120 to 180 words: lead with the answer, give only the reasoning that changes what the patient does, then stop.
